...
**What goes here:**
- `02-my-samples/` - Examples of your past writing (subfolders per track: 01-content, 02-communication, 03-thinking)
- `01-context/01-context.md` - Answer questions about yourself and your business
- `_INBOX/` - A visible capture point for new stuff. Drop anything here first, organize later.
- Research documents
- Reference materials
- Data and analytics
...
| **Prompts** | Copy-paste instructions | `01-learn-from-context.md` |
...
| `feedback-audience.md` | Audience signals (comments, reactions) | After publishing |
| `feedback-system.md` | Your corrections and preferences for agents | Whenever you give agents feedback |
...
**Edit:** `B-brain/01-context/01-context.md`
**Prompt:** `T-tools/01-prompts/[your-track]/01-learn-from-context.md`
...
**Prompt:** `T-tools/01-prompts/[your-track]/02-learn-from-samples.md`
...
**Prompt:** `T-tools/01-prompts/[your-track]/03-create-....md`
...
**Prompt:** `T-tools/01-prompts/[your-track]/04-close-the-loop.md`
...
5. **Use INBOX for quick capture.** Don't overthink where things go. Drop new stuff in `B-brain/_INBOX/` and organize later.
