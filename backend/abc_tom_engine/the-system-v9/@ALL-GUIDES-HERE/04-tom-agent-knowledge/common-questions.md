...
1. Open `B-brain/01-context/01-context.md`
2. Answer the questions (10-15 minutes)
3. Copy the prompt from `T-tools/01-prompts/[your-track]/01-learn-from-context.md`
...
2. **Not enough writing samples**
   ...
   - Run `02-learn-from-samples.md` again
...
1. Check if there's a skill in `T-tools/02-skills/`
...
4. Or use: `T-tools/01-prompts/04-BONUS/01-create-new-agent.md`
...
Use `T-tools/01-prompts/04-BONUS/08-connect-api-keys.md`.
...
Store keys in `C-core/api-keys-registry.md` (don't share this file).

---

### "How do I automate the revision loop?"

Use `T-tools/01-prompts/04-BONUS/07-enable-auto-revision-loop.md`.
