...
**What to do:**
1. Open your track folder in `T-tools/01-prompts/` (`01-content/`, `02-communication/`, or `03-thinking/`)
...
**Bonus:** Try a different track. If you did content in the workshop, try communication or thinking. Same system, completely different output.
...
**What to do:**
1. Open your samples folder in `B-brain/02-my-samples/` (01-content, 02-communication, or 03-thinking)
2. Add 2-3 more samples of your real work. The best pieces you've written.
3. Run prompt `02-learn-from-samples.md` from your track folder again
...
**Tip:** Got random notes, ideas, or files you're not sure about? Drop them in `B-brain/_INBOX/`. It's your junk drawer. You can sort them later, or ask Claude to sort them for you.

---

## Day 3: Meet the Bonus Prompts

There are 15 bonus prompts in `T-tools/01-prompts/04-BONUS/`. Today, explore them.
...
**What to do:**
1. Open `T-tools/01-prompts/04-BONUS/01-create-new-agent.md`
...
**What to do:**
1. Open `T-tools/01-prompts/04-BONUS/03-create-new-skill.md`
2. Think: what content type do you create regularly that has specific rules?
3. Fill in the details and paste the prompt

**Note:** Your system already includes powerful skills: social post, blog post, newsletter, sales proposal, document summary, meeting notes, PRD, stakeholder update, Hebrew writing, and more. Check `T-tools/02-skills/` to see them all.
...
**The result:** A playbook file in `T-tools/02-skills/` that any agent can reference when doing that type of work.
...
4. **Sort your INBOX.** Check `B-brain/_INBOX/`. Anything in there? Move it to the right folder, or ask Claude to sort it for you.
...
1. Open `T-tools/01-prompts/04-BONUS/07-enable-auto-revision-loop.md`
...
1. Open `T-tools/01-prompts/04-BONUS/09-content-calendar.md`
...
- Run the weekly review: `T-tools/01-prompts/04-BONUS/13-weekly-review.md`
...
## Quick Reference: All 15 Bonus Prompts

| # | File | What It Does | Best Time to Try |
|---|------|-------------|-----------------|
| 01 | `create-new-agent.md` | Recruit a new team member | Day 4 |
| 02 | `enhance-agent-with-research.md` | Make an agent world-class with deep research | Right after creating an agent |
| 03 | `create-new-skill.md` | Build an expert playbook | Day 5 |
| 04 | `create-new-workflow.md` | Create a multi-step agent pipeline | When you want agents to work in sequence |
| 05 | `train-agent-on-document.md` | Train an agent on any document | When you have content worth learning from |
| 06 | `clone-voice-from-conversation.md` | Extract your real voice from casual messages | When agents sound too formal |
| 07 | `enable-auto-revision-loop.md` | Agents review each other automatically | Day 7 |
...
| 14 | `audit-my-system.md` | Full system health check with scoring | When output quality drops |
| 15 | `client-onboarding-flow.md` | Generate questionnaire, welcome email, kickoff agenda | When you sign a new client |
