...
3. **Reads the relevant skill:**
   - Meeting → `T-tools/02-skills/meeting-notes-skill/`
   - Document → `T-tools/02-skills/document-summary-skill/`
   - PRD → `T-tools/02-skills/prd-skill/`
   - Stakeholder update → `T-tools/02-skills/stakeholder-update-skill/`
